    ...
    def __init__(self) -> None:
        ...
        self.agent = Agent[ChatDeps, str](
            ...
            system_prompt=(
                ...
                "To surface a component, call get_component_data with its component_id — that single call "
                "fetches the payload, ships it to the frontend over SSE so the page renders, AND returns the "
                "same payload to you. Use the returned data to ground your reply. "
